 ...
 */
final class Version20220223165655 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE survivors ADD survivor_perk3_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE survivors DROP survivor_perk3_id');
    }
}
